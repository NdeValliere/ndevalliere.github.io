...
$(window).on('load', function() {
  ...
  if (isMobile || (w < 645) ) {
    injectContent();
    $('.left p').append(' &nbsp; <span id="new-line" style="letter-spacing: -0.125px;">––––</span>');
  }
});
...
function injectContent() {
  var inject1 = $('#inject1'),
    ...
    inject2.append(' <a href="https://vimeo.com/246483691" target="_blank">drawing machines<small id="small--8">8</small></a>, <a href="http://2018.csmgraphicdesign.com/dev/files/z-01.jpg" target="_blank">sculptures<small id="small--9">9</small></a> and redesign my portfolio <span class="spacer spacer--inline"></span> over <a href="https://nathalie-devalliere-60cn.squarespace.com/archive" target="_blank">1 /<small class="small--date" id="small--11">Sep 2016</small></a>&nbsp;');
}
